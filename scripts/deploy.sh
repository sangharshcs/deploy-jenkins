...
docker stack deploy --resolve-image never -c "${ROOT_DIR}/stack.yml" jenkins

echo ""
echo "Jenkins will be available at: ${JENKINS_BASE_URL}/jenkins"
echo "Monitor with: docker stack ps jenkins"
echo "Logs:         docker service logs -f jenkins_controller"
